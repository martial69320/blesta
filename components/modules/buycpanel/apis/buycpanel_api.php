 ...
 *
 * Documentation on the BuycPanel API:
 * https://helpdesk.buycpanel.com/index.php?/Knowledgebase/Article/View/27/0/building-your-own-buycpanel-licensing-system-using-our-api
 *
...
class BuycpanelApi
{
    ...
    private $key;
    /**
     * @var bool Whether or not to process in test mode
     */
    private $test_mode;
     ...
     * @param bool $test_mode Whether or not to process in test mode (optional, default true)
     */
     ...
     */
    public function submit($url, array $args = [])
    {
        $vars = [
            'login' => $this->email,
            'key' => $this->key
