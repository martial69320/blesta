...
class Gogetssl extends Module
{
     ...
     *  with key/value pairs for 'name' and 'url', representing the name and URL of the authors of this module
     */
    ...
    public function getPackageFields($vars = null)
    {
        ...
        $gogetssl_product->attach(
            $fields->fieldSelect(
                ...
                $gogetssl_products,
                $this->Html->ifSet($vars->meta['gogetssl_product']),
                ['id' => 'gogetssl_product']
            )
        );
    ...
    public function getEmailTags()
    {
        return [
            'module' => [],
            'package' => ['gogetssl_product'],
            'service' => [
                'gogetssl_approver_email', 'gogetssl_fqdn', 'gogetssl_webserver_type', 'gogetssl_csr',
    ...
    private function makeAddFields($package, $vars)
    {
        ...
        $gogetssl_fqdn->attach(
            $fields->fieldText('gogetssl_fqdn', $this->Html->ifSet($vars->gogetssl_fqdn), ['id' => 'gogetssl_fqdn'])
        );
        ...
        $gogetssl_approver_email->attach(
            $fields->fieldSelect(
                'gogetssl_approver_email',
                $gogetssl_approver_emails,
                $this->Html->ifSet($vars->gogetssl_approver_email),
        ...
        $gogetssl_csr->attach(
            $fields->fieldTextArea('gogetssl_csr', $this->Html->ifSet($vars->gogetssl_csr), ['id' => 'gogetssl_csr'])
        );
        ...
        $gogetssl_webserver_type->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet($vars->gogetssl_webserver_type),
        ...
        $gogetssl_title->attach(
            $fields->fieldText('gogetssl_title', $this->Html->ifSet($vars->gogetssl_title), ['id' => 'gogetssl_title'])
        );
        ...
        $gogetssl_firstname->attach(
            $fields->fieldText(
                'gogetssl_firstname',
                $this->Html->ifSet($vars->gogetssl_firstname),
        ...
        $gogetssl_lastname->attach(
            $fields->fieldText(
                'gogetssl_lastname',
                $this->Html->ifSet($vars->gogetssl_lastname),
        ...
        $gogetssl_address1->attach(
            $fields->fieldText(
                'gogetssl_address1',
                $this->Html->ifSet($vars->gogetssl_address1),
        ...
        $gogetssl_address2->attach(
            $fields->fieldText(
                'gogetssl_address2',
                $this->Html->ifSet($vars->gogetssl_address2),
        ...
        $gogetssl_city->attach(
            $fields->fieldText('gogetssl_city', $this->Html->ifSet($vars->gogetssl_city), ['id' => 'gogetssl_city'])
        );
        ...
        $gogetssl_zip->attach(
            $fields->fieldText('gogetssl_zip', $this->Html->ifSet($vars->gogetssl_zip), ['id' => 'gogetssl_zip'])
        );
        ...
        $gogetssl_state->attach(
            $fields->fieldText('gogetssl_state', $this->Html->ifSet($vars->gogetssl_state), ['id' => 'gogetssl_state'])
        );
        ...
        $gogetssl_country->attach(
            $fields->fieldText(
                'gogetssl_country',
                $this->Html->ifSet($vars->gogetssl_country),
                ['id' => 'gogetssl_country']
            )
        );
        ...
        $gogetssl_email->attach(
            $fields->fieldText('gogetssl_email', $this->Html->ifSet($vars->gogetssl_email), ['id' => 'gogetssl_email'])
        );
        ...
        $gogetssl_number->attach(
            $fields->fieldText(
                'gogetssl_number',
                $this->Html->ifSet($vars->gogetssl_number),
                ['id' => 'gogetssl_number']
            )
        );
        ...
        $gogetssl_fax->attach(
            $fields->fieldText(
                'gogetssl_fax',
                $this->Html->ifSet($vars->gogetssl_fax),
                ['id' => 'gogetssl_fax']
            )
        );
        ...
        $gogetssl_organization->attach(
            $fields->fieldText(
                'gogetssl_organization',
                $this->Html->ifSet($vars->gogetssl_organization),
        ...
        $gogetssl_organization_unit->attach(
            $fields->fieldText(
                'gogetssl_organization_unit',
                $this->Html->ifSet($vars->gogetssl_organization_unit),
