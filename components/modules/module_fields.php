...
class ModuleFields
{
     ...
     * @return ModuleField A ModuleField object to be passed into one of the various field methods to assign this
     *  label to that field
     */
     ...
     * @see ModuleField::attach()
     */
    public function fieldImage($name, $value = null, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldReset($name, $value = null, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldCheckbox($name, $value = null, $checked = false, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldRadio($name, $value = null, $checked = false, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldTextarea($name, $value = null, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldPassword($name, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldFile($name, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldButton($name, $value = null, $attributes = [], ModuleField $label = null)
    {
     ...
     * @see ModuleField::attach()
     */
    public function fieldSubmit($name, $value = null, $attributes = [], ModuleField $label = null)
    {
