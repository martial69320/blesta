...
class Interworx extends Module
{
    ...
    {
        return [
            'module' => ['host_name', 'name_servers', 'notes'],
            'package' => ['type', 'package'],
            'service' => ['interworx_username', 'interworx_email', 'interworx_password', 'interworx_domain']
        ];
    }
    ...
    public function getAdminAddFields($package, $vars = null)
    {
        ...
        if ($package->meta->type != 'reseller') {
            ...
            $domain->attach(
                $fields->fieldText(
                    'interworx_domain',
                    $this->Html->ifSet($vars->interworx_domain),
                    ['id' => 'interworx_domain']
                )
            );
            ...
            $reseller_id->attach(
                $fields->fieldText(
                    'interworx_reseller_id',
                    $this->Html->ifSet($vars->interworx_reseller_id),
        ...
        $email->attach(
            $fields->fieldText('interworx_email', $this->Html->ifSet($vars->interworx_email), ['id'=>'interworx_email'])
        );
        // Add tooltip
        ...
        $username->attach(
            $fields->fieldText(
                'interworx_username',
                $this->Html->ifSet($vars->interworx_username),
        ...
        $password->attach(
            $fields->fieldPassword(
                'interworx_password',
                ['id' => 'interworx_password', 'value' => $this->Html->ifSet($vars->interworx_password)]
            )
        );
        // Add tooltip
        ...
        $confirm_password->attach(
            $fields->fieldPassword(
                'interworx_confirm_password',
                ['id' => 'interworx_confirm_password', 'value' => $this->Html->ifSet($vars->interworx_password)]
            )
        );
        // Add tooltip
    ...
    public function getClientAddFields($package, $vars = null)
    {
        ...
        $domain->attach(
            $fields->fieldText(
                'interworx_domain',
                $this->Html->ifSet($vars->interworx_domain, $this->Html->ifSet($vars->domain)),
                ['id' => 'interworx_domain']
            )
        );
        // Set the label as a field
    ...
    public function getAdminEditFields($package, $vars = null)
    {
        ...
        $email->attach(
            $fields->fieldText(
                'interworx_email',
                $this->Html->ifSet($vars->interworx_email),
                ['id' => 'interworx_email']
            )
        );
        // Set the label as a field
