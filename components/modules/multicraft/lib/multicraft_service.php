...
class MulticraftService
{
    ...
    public function getAdminAddFields($package, $vars = null)
    {
        ...
        $server_name->attach(
            $fields->fieldText(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->server_name)
                ),
        ...
        $server_id->attach(
            $fields->fieldText(
                $this->service_prefix . 'server_id',
                $this->Html->ifSet($vars->{$this->service_prefix . 'server_id'}),
        ...
        $user_id->attach(
            $fields->fieldText(
                $this->service_prefix . 'user_id',
                $this->Html->ifSet($vars->{$this->service_prefix . 'user_id'}),
        ...
        $daemon_id->attach(
            $fields->fieldText(
                $this->service_prefix . 'daemon_id',
                $this->Html->ifSet($vars->{$this->service_prefix . 'daemon_id'}),
        ...
        $ip->attach(
            $fields->fieldText(
                ...
                $this->Html->ifSet($vars->{$this->service_prefix . 'ip'}),
        ...
        $port->attach(
            $fields->fieldText(
                $this->service_prefix . 'port',
                $this->Html->ifSet($vars->{$this->service_prefix . 'port'}, $this->Html->ifSet($package->meta->port)),
        ...
        $players->attach(
            $fields->fieldText(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->players)
                ),
        ...
        $memory->attach(
            $fields->fieldText(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->memory)
                ),
        ...
        $jar->attach(
            $fields->fieldText(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->jarfile)
                ),
        ...
        $jardir->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->jardir)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->user_jar)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->user_name)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->user_schedule)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->user_ftp)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->user_visibility)
                ),
        ...
        $default_level->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->default_level)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->autostart)
                ),
        ...
        $label->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->create_ftp)
                ),
        ...
        $server_visibility->attach(
            $fields->fieldSelect(
                ...
                $this->Html->ifSet(
                    ...
                    $this->Html->ifSet($package->meta->server_visibility)
                ),
