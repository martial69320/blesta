...
class Multicraft extends Module
{
    ...
    {
        return [
            'actions' => ['name' => Language::_('Multicraft.tab_client_actions', true), 'icon' => 'fa fa-gears'],
            'players' => ['name' => Language::_('Multicraft.tab_client_players', true), 'icon' => 'fa fa-users'],
            'console' => ['name' => Language::_('Multicraft.tab_client_console', true), 'icon' => 'fa fa-terminal']
        ];
    }
