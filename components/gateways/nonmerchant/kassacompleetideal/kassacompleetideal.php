 ...
 *
 * @package blesta
 * @subpackage blesta.components.gateways.kassacompleetideal
 * @copyright Copyright (c) 2019, Phillips Data, Inc.
 * @license http://www.blesta.com/license/ The Blesta License Agreement
 * @link http://www.blesta.com/ Blesta
 */
class Kassacompleetideal extends NonmerchantGateway
{
    /**
    ...
    public function __construct()
    {
        ...
        Language::loadLang('kassacompleetideal', null, dirname(__FILE__) . DS . 'language' . DS);
    }
        ...
        if (isset($_POST['submit_kassacompleet'])) {
            ...
            $params = [
                ...
                'webhook_url' => Configure::get('Blesta.gw_callback_url')
                    . Configure::get('Blesta.company_id') . '/kassacompleetideal/',
                'transactions' => [
                    (object)[
    ...
    private function buildForm()
    {
        ...
        $this->view->set('issuer_ids', $issuer_ids);
