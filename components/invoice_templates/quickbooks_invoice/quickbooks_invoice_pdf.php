...
class QuickbooksInvoicePdf extends TcpdfWrapper
{
    ...
    public function drawInvoice()
    {
        ...
        // end each page
        $clone = clone $this;
        $inv_lines = (isset($clone->invoice->line_items) && is_array($clone->invoice->line_items)
            ? count($clone->invoice->line_items)
            : 0
        );
