...
class AdminCompanyGroups extends AppController
{
    ...
    private $client_group_fields = [
        ...
        'clients_cancel_services', 'synchronize_addons',
        ...
        'send_payment_notices', 'autodebit', 'show_client_tax_id',
        'client_prorate_credits', 'process_paid_service_changes',
        'cancel_service_changes_days', 'inv_group_services',
        'void_invoice_canceled_service', 'void_inv_canceled_service_days',
    ...
    public function add()
    {
        ...
        if (!empty($this->post)) {
            ...
            $checkboxes = ['autodebit', 'client_set_invoice', 'inv_suspended_services', 'clients_cancel_services',
                'synchronize_addons', 'client_create_addons', 'auto_apply_credits', 'auto_paid_pending_services',
                'client_change_service_term', 'client_prorate_credits', 'client_change_service_package',
                'send_payment_notices', 'show_client_tax_id', 'process_paid_service_changes', 'inv_group_services',
            ...
            $white_list = ['company', 'title', 'address1', 'address2', 'city', 'country', 'state', 'zip'];
