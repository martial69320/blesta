...
class Cron extends AppController
{
    ...
    public function all($cron_log_group = null)
    {
        ...
        $tasks = ['createInvoices', 'applyCredits', 'autoDebitInvoices', 'cardExpirationReminders',
    ...
    private function getCronTask($cron_task_key, $dir = null, $system = false, $task_type = 'system')
    {
        ...
        if (isset($this->cron_tasks[$task_type][$cron_task_key . $dir])) {
            $cron_task = $this->cron_tasks[$task_type][$cron_task_key . $dir];
        } else {
