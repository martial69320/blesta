...
class AdminPackages extends AppController
{
    ...
    public function index()
    {
        ...
        $this->set('packages', $this->Packages->getList($page, [$sort => $order], $status));
        $this->set('sort', $sort);
    ...
    public function groups()
    {
        ...
        $package_groups = $this->PackageGroups->getList($this->company_id, $page, $type, [$sort => $order]);
    ...
    public function addGroup()
    {
        ...
        $vars->names = $this->arrayValuesToObject((array)$this->Html->ifSet($vars->names, []));
        $vars->descriptions = $this->arrayValuesToObject((array)$this->Html->ifSet($vars->descriptions, []));
