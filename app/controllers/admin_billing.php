...
class AdminBilling extends AppController
{
    ...
    public function invoices()
    {
        ...
        if ($status == 'recurring') {
            ...
            $invoices = $this->Invoices->getRecurringList(null, $page, [$sort => $order]);
    ...
    public function transactions()
    {
        ...
        $this->set('transactions', $this->Transactions->getList(null, $status, $page, [$sort => $order]));
        $this->set('status', $status);
        $this->set('status_count', $status_count);
        $this->set('sort', $sort);
        $this->set('order', $order);
    ...
    public function services()
    {
        ...
        $services = $this->Services->getList(null, $status, $page, [$sort => $order]);
