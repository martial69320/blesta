...
class Themes extends AppModel
{
    ...
    public function change($id, $type = 'admin')
    {
        ...
        if ($this->Input->validates($vars)) {
            ...
            $this->Record->duplicate('value', '=', $vars['id'])->
                insert('company_settings', ['key' => $key, 'company_id' => $company_id, 'value' => $id]);
        }
    }
    ...
    private function getRules(array $vars = [], $edit = false)
    {
        ...
        $rules = [
            ...
            'colors' => [
                'exist' => [
                    'rule' => [[$this, 'validateColorsSet'], $this->ifSet($vars['type'])],
        ...
        if ($edit) {
            ...
            $rules['company_id']['set'] = [
                'rule' => [[$this, 'validateCompanySet'], $this->ifSet($vars['id']), $this->ifSet($vars['type'])],
