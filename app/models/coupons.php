...
class Coupons extends AppModel
{
     ...
     * @return bool True if this coupon is not set as an inclusive recurring
     *  coupon that contains any discounts of type "Amount", or false otherwise
     * @deprecated since version 4.1.0
     */
    ...
    private function getRules(array $vars, $edit = false)
    {
        ...
        $rules = [
            ...
            'code' => [
                ...
                'unique' => [
                    'rule' => [[$this, 'validateUniqueCode'], $this->ifSet($vars['coupon_id'], null)],
