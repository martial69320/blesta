...
$lang['Invoices.!line_item.service_option_prorated_upgrade_text_description'] = '↳ Prorated Upgrade of %1$s (%2$s - %3$s)'; // %1$s is the service option label name, %2$s is the current date, %3$s is the service's next renew date
$lang['Invoices.!line_item.service_option_prorated_upgrade_text_description_onetime'] = '↳ Prorated Upgrade of %1$s'; // %1$s is the service option label name
...
$lang['Invoices.!line_item.service_option_prorated_addition_text_description'] = '↳ Prorated Addition of %1$s (%2$s - %3$s)'; // %1$s is the service option label name, %2$s is the current date, %3$s is the service's next renew date
$lang['Invoices.!line_item.service_option_prorated_addition_text_description_onetime'] = '↳ Prorated Addition of %1$s'; // %1$s is the service option label name
