...
$lang['Automation.task.create_invoices.recurring_invoice_failed'] = 'Unable to create a new invoice from recurring invoice #%1$s for client #%2$s.'; // %1$s is the recurring invoic enumber, %2$s is the client ID
