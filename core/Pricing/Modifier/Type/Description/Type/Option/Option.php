...
class Option extends AbstractDescription
{
    ...
    private function getBaseFields(array $meta)
    {
        ...
        return array_merge(
            compact('option', 'value', 'qty', 'type', 'state', 'startDate', 'endDate'),
