    ...
    public function getSettingFields($vars = null)
    {
        ...
        $fields->setField(
            $api_key->attach(
                $fields->fieldText(
                    ...
                    $this->Html->ifSet($vars->fraudlabspro_api_key),
        ...
        $fields->setField(
            $reject_score->attach(
                $fields->fieldText(
                    'fraudlabspro_reject_score',
                    $this->Html->ifSet($vars->fraudlabspro_reject_score, '80'),
        ...
        $fields->setField(
            $review_score->attach(
                $fields->fieldText(
                    'fraudlabspro_review_score',
                    $this->Html->ifSet($vars->fraudlabspro_review_score, '10'),
        ...
        $follow_flp_result->attach(
            $fields->fieldRadio(
                'fraudlabspro_follow_flp_result',
                'yes',
                $this->Html->ifSet($vars->fraudlabspro_follow_flp_result, 'yes') == 'yes',
        ...
        $follow_flp_result->attach(
            $fields->fieldRadio(
                'fraudlabspro_follow_flp_result',
                'no',
                $this->Html->ifSet($vars->fraudlabspro_follow_flp_result) == 'no',
