    ...
    public function getSettingFields($vars = null)
    {
        ...
        $fields->setField(
            $server->attach(
                $fields->fieldText(
                    'maxmind_server',
                    $this->Html->ifSet($vars->maxmind_server, 'minfraud.maxmind.com'),
                    ['id' => 'maxmind_server']
                )
            )
        );
        ...
        $fields->setField(
            $key->attach(
                $fields->fieldText('maxmind_key', $this->Html->ifSet($vars->maxmind_key), ['id' => 'maxmind_key'])
            )
        );
        ...
        $fields->setField(
            $reject_score->attach(
                $fields->fieldText(
                    'maxmind_reject_score',
                    $this->Html->ifSet($vars->maxmind_reject_score, '80'),
        ...
        $fields->setField(
            $review_score->attach(
                $fields->fieldText(
                    'maxmind_review_score',
                    $this->Html->ifSet($vars->maxmind_review_score, '10'),
        ...
        $free_email->attach(
            $fields->fieldRadio(
                'maxmind_free_email',
                'allow',
                $this->Html->ifSet($vars->maxmind_free_email, 'allow') == 'allow',
        ...
        $free_email->attach(
            $fields->fieldRadio(
                'maxmind_free_email',
                'review',
                $this->Html->ifSet($vars->maxmind_free_email) == 'review',
        ...
        $free_email->attach(
            $fields->fieldRadio(
                'maxmind_free_email',
                'reject',
                $this->Html->ifSet($vars->maxmind_free_email) == 'reject',
        ...
        $country_mismatch->attach(
            $fields->fieldRadio(
                'maxmind_country_mismatch',
                'allow',
                $this->Html->ifSet($vars->maxmind_country_mismatch, 'allow') == 'allow',
        ...
        $country_mismatch->attach(
            $fields->fieldRadio(
                'maxmind_country_mismatch',
                'review',
                $this->Html->ifSet($vars->maxmind_country_mismatch) == 'review',
        ...
        $country_mismatch->attach(
            $fields->fieldRadio(
                'maxmind_country_mismatch',
                'reject',
                $this->Html->ifSet($vars->maxmind_country_mismatch) == 'reject',
        ...
        $risky_country->attach(
            $fields->fieldRadio(
                'maxmind_risky_country',
                'allow',
                $this->Html->ifSet($vars->maxmind_risky_country, 'allow') == 'allow',
        ...
        $risky_country->attach(
            $fields->fieldRadio(
                'maxmind_risky_country',
                'review',
                $this->Html->ifSet($vars->maxmind_risky_country) == 'review',
        ...
        $risky_country->attach(
            $fields->fieldRadio(
                'maxmind_risky_country',
                'reject',
                $this->Html->ifSet($vars->maxmind_risky_country) == 'reject',
        ...
        $anon_proxy->attach(
            $fields->fieldRadio(
                'maxmind_anon_proxy',
                'allow',
                $this->Html->ifSet($vars->maxmind_anon_proxy, 'allow') == 'allow',
        ...
        $anon_proxy->attach(
            $fields->fieldRadio(
                'maxmind_anon_proxy',
                'review',
                $this->Html->ifSet($vars->maxmind_anon_proxy) == 'review',
        ...
        $anon_proxy->attach(
            $fields->fieldRadio(
                'maxmind_anon_proxy',
                'reject',
                $this->Html->ifSet($vars->maxmind_anon_proxy) == 'reject',
