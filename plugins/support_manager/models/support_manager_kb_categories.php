...
class SupportManagerKbCategories extends SupportManagerModel
{
     ...
     *  (i.e. "public", "private", "hidden"; optional, default null for all)
    ...
    private function getRules(array $vars, $edit = false)
    {
        $rules = [
            'parent_id' => [
                ...
                'valid_company' => [
                    'if_set' => true,
                    'rule' => [[$this, 'validateCompanyMatches'], $this->ifSet($vars['company_id'])],
                    'message' => $this->_('SupportManagerKbCategories.!error.parent_id.valid_company')
                ],
                'valid_parent' => [
                    'if_set' => true,
                    'rule' => [[$this, 'validateParent'], $this->ifSet($vars['category_id'])],
